...
$config['mongo_db']['default']['hostname'] = 'metro2019-arkgs.mongodb.net';
$config['mongo_db']['default']['port'] = '27017';
$config['mongo_db']['default']['username'] = 'achmadhafizh';
$config['mongo_db']['default']['password'] = 'Awaslupa1234';
$config['mongo_db']['default']['database'] = 'smartretail';
...
$config['mongo_db']['test']['hostname'] = 'metro2019-arkgs.mongodb.net';
$config['mongo_db']['test']['port'] = '27017';
$config['mongo_db']['test']['username'] = 'achmadhafizh';
$config['mongo_db']['test']['password'] = 'Awaslupa1234';
...
$config['mongo_db']['test']['read_preference'] = 'primary';
$config['mongo_db']['test']['read_concern'] = 'local'; //'local', 'majority' or 'linearizable'
$config['mongo_db']['test']['legacy_support'] = TRUE;
