...
<html>
    <head>
        ...
        <style>
            ...
            */
            body{
                background: url(<?php echo base_url('assets/custom/img/bg1.png'); ?>);
    ...
    <body>
        ...
        <div class="wrap">
            ...
            <!--start-content------>
            <div class="content">
                <img src="<?php echo base_url('assets/custom/img/error-img.png'); ?>" title="error" />
                <p><span><label>O</label>hh.....</span>You Requested the page that is no longer There.</p>
                <!-- <a href="#">Back To Home</a> -->
                <div class="copy-right">
                    <p>&copy; 2018 PT. Metropolitan Retailmart | All Rights Reserved</a></p>
                </div>
            </div>
            <!--End-Cotent------>
        </div>
